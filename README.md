...
| [The Venous Return Wars](tools/venous-return-wars.html) | An interactive teaching essay on the Guyton versus Brengelmann dispute, with four live rigs you drive yourself: two tanks and a pump, a venous return curve you can reshape, a vasodilate-then-defend-blood-pressure sequence, and a fourth separating what you changed, the contents or the container, from what the change became, flow or pressure. |
